...
const mapHiragana2Romaji = reverseMap(
  require('./map/hiragana2romaji_reversed')
);
...
class RomajiConv {
  ...
  constructor (someString) {
    ...
    this.romaji = this.convert(this.hiragana, mapHiragana2Romaji);
    this.romajiDoubleN = this.convert(this.hiragana.replace("ん", "んん"), mapHiragana2Romaji);
  }
  ...
  toRomaji (doubleN=false) {
    if (!doubleN) {
      return this.romaji;
    } else {
      return this.romajiDoubleN
    }
  }
}
...
const toRomaji = (someString, doubleN=false) => {
  const instance = new RomajiConv(someString);
  return instance.toRomaji(doubleN);
};

module.exports = romajiConv;
module.exports.toHiragana = toHiragana;
module.exports.toKatakana = toKatakana;
module.exports.toRomaji = toRomaji;
